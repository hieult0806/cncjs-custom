...
class AutoCaptureWidget extends PureComponent {
  static propTypes = {
  ...
  controllerEvents = {
    ...
    'serialport:read': (data) => {
      //TODO: Thực hiện việc chụp ảnh ở đây
      this.state.receivedText = data;
    ...
    return (
      <Widget fullscreen={isFullscreen}>
        ...
        >
          ...
          <div>
            Received Text: {this.state.receivedText}
          </div>
          {/* <Custom
            ref={node => {
              this.content = node;
...
export default AutoCaptureWidget;